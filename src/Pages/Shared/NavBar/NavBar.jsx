...
const NavBar = () => {
    ...
    const navLinks = (
        <>
            ...
            {
                user ? <> <li><Link onClick={handelLogOut}  className="hover:text-[#EEFF25]">LogOut</Link></li> </> : <> <li> <Link to="/login" className="hover:text-[#EEFF25]">Login</Link></li> </>
            }
        </>
    )
    return (
        <div className="">
            ...
            <div className="navbar fixed z-10 bg-opacity-30  bg-black text-white">
                <div className="">
                    ...
                    <div className=" hidden lg:pl-72   lg:flex">
